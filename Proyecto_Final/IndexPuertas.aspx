			...
			<div id="wrapper">
                ...
                <asp:Panel ID="main" runat="server">
                    <asp:Panel ID="Panel1" class="inner" runat="server">
						...
						<div class="field">
                            <asp:GridView ID="PuertasView" runat="server" AutoGenerateColumns="False" AutoGenerateDeleteButton="False" AutoGenerateSelectButton="True" DataKeyNames="cod_puerta" DataSourceID="SqlDataSource1" OnSelectedIndexChanged="PuertasView_SelectedIndexChanged" >
                                <Columns>
                                    <asp:BoundField DataField="cod_puerta" HeaderText="cod_puerta" ReadOnly="True" SortExpression="cod_puerta" />
                                    <asp:BoundField DataField="detalle" HeaderText="detalle" ReadOnly="True" SortExpression="detalle" />
                                </Columns>
                            </asp:GridView>
...
From   PUERTA;" DeleteCommand="DELETE FROM [PUERTA] where [cod_puerta]=@cod_puerta">
                                <DeleteParameters>
                                    <asp:Parameter Name="cod_puerta" />
                                </DeleteParameters>
                            </asp:SqlDataSource>
						</div>
                        <br />
